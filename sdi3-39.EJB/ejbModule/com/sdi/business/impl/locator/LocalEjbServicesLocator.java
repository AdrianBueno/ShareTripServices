...
public class LocalEjbServicesLocator implements ServicesFactory {
	...
	private static final String TRIPS_SERVICE_JNDI_KEY = "java:global/"
			+ "sdi3-39/" + "sdi3-39.EJB/" + "EjbTripsService!"
			+ "com.sdi.business.impl.face.local.LocalTripsService";
	private static final String USERS_SERVICE_JNDI_KEY = "java:global/"
			+ "sdi3-39/" + "sdi3-39.EJB/" + "EjbUsersService!"
			+ "com.sdi.business.impl.face.local.LocalUsersService";
	private static final String SEATS_SERVICE_JNDI_KEY = "java:global/"
			+ "sdi3-39/" + "sdi3-39.EJB/" + "EjbSeatsService!"
			+ "com.sdi.business.impl.face.local.LocalSeatsService";
	private static final String APPLIES_SERVICE_JNDI_KEY = "java:global/"
			+ "sdi3-39/" + "sdi3-39.EJB/" + "EjbAppliesService!"
			+ "com.sdi.business.impl.face.local.LocalAppliesService";
	private static final String RATINGS_SERVICE_JNDI_KEY = "java:global/"
			+ "sdi3-39/" + "sdi3-39.EJB/" + "EjbRatingsService!"
			+ "com.sdi.business.impl.face.local.LocalRatingsService";
	private static final String ADMIN_SERVICE_JNDI_KEY = "java:global/"
			+ "sdi3-39/" + "sdi3-39.EJB/" + "EjbAdminService!"
			+ "com.sdi.business.impl.face.local.LocalAdminService";
